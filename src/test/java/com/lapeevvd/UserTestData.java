...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, "User", "password", "user@yandex.ru", 2000, Role.ROLE_USER);
    public static final User ADMIN = new User(ADMIN_ID, "Admin", "admin", "admin@gmail.com", 2000, Role.ROLE_ADMIN, Role.ROLE_USER);
}

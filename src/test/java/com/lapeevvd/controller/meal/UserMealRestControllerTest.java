...
public class UserMealRestControllerTest extends AbstractControllerTest {
    ...
    public void testDelete() throws Exception {
        mockMvc.perform(delete(REST_URL + MEAL_ID).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(put(REST_URL + MEAL_ID).contentType(MediaType.APPLICATION_JSON)
    ...
    public void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "between?startDateTime=2016-01-15T07:00&endDateTime=2016-01-16T11:00:00"))
                .andExpect(status().isOk())
                .andDo(print())

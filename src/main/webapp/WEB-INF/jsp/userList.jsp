...
<div class="jumbotron">
    <div class="container">
        <div class="shadow">
            <legend><fmt:message key="users.title"/></legend>
            ...
            <div class="view-box">
                ...
                <table class="table table-striped display" id="datatable">
                    ...
                    <%--<c:forEach items="${userList}" var="user">
                        <jsp:useBean id="user" scope="page" type="com.lapeevvd.model.User"/>
                        <tr id="${user.id}">
                            <td><c:out value="${user.name}"/></td>
                            <td><a href="mailto:${user.email}">${user.email}</a></td>
                            <td>${user.roles}</td>
                            <td>
                                <input type="checkbox" <c:if test="${user.enabled}">checked</c:if> id="${user.id}" onclick="enable($(this))"/>
                            </td>
...
<script type="text/javascript" src="resources/js/userDatatebles.js"></script>
</html>